...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="CenterTableHN">
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Drp_House" AutoPostBack="true" OnSelectedIndexChanged="Drp_House_SelectedIndexChanged" Width="130px" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Drp_Election" AutoPostBack="true" OnSelectedIndexChanged="Drp_Election_SelectedIndexChanged" Width="130px" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>&nbsp;
    ...
    <%
          ...
          {
              if (ToNominee.Where(x => x.Nom_DesignationId == Convert.ToInt32(lDesignation.Key)).ToList().Count <= 0)
                  continue;
